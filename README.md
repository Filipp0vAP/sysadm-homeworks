...
В [main](https://github.com/Filipp0vAP/netology-sysadm-homeworks/tree/main) ветке находятся актуальные задания без ответов.

В ветке [devsys-15](https://github.com/Filipp0vAP/netology-sysadm-homeworks/tree/devsys-15) находятся решенные задания с ответами.
